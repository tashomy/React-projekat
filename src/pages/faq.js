...
class FaqPage extends Component {
    ...
    constructor(props) {
        ...
        this.state = { showMeOne:true, showMeTwo:false, showMeThree:false, showMeFour:false, loader: true }
    }
    ...
    render() {
        ...
        return(
            <div className="faq">
                ...
                <button onClick={this.handleClick} id="Delivery" style={divStyle}>Delivery</button>
                <button onClick={this.handleClick2} id="Return" style={divStyle}>Return Policy</button>
                <button onClick={this.handleClick3} id="Where" style={divStyle}>Where to find us</button>
                <button onClick={this.handleClick4} id="Tech" style={divStyle}>Tech support</button>
                </div>
